...
class TissueUI(QWidget):
    def __init__(self, parent=None, main_layout=None):
        ...
        replaceAction = Action(
            self.tissue_groupbox,
            "replaceChannelAction",
            resource_path("assets/icons/replace.png"),
        )
        ...
        alignAction = Action(
            self.tissue_groupbox,
            "alignTissueAction",
            resource_path("assets/icons/align.png"),
        )
    ...
    def __retranslateUI(self):
        ...
        self.replace_channel_button.setToolTip(
            _translate("MainWindow", "Replace Channel 2 with Tissue")
        )
